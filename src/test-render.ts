...
async function main() {
  ...
  // Numbered list
  // const prompt = 'What are some tips for having great conversations with you?'
  // const response = 'Here are a few tips for having a great conversation with me:\n' +
  // '\n' +
  ...
  //   const prompt = 'Give me some **markdown**'
  //   const response = `
  // # Heading level 1
